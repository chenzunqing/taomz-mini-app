...
@Getter
@Setter
public class ActivityMemberConfigDTO implements Serializable {
    /**
     * 活动会员设置表主键ID
     */
    private Integer memberConfigId;
     ...
     * 虚拟参会已申请人数
     */
    private int virtualApplyEnterNum;

    /**
     * 逛展已申请人数
     */
    private int applyVisitExhibitionNum;

    /**
     * 晚宴已申请人数
     */
    private int applyBanquetNum;
     ...
     * 当前登录用户参会已申请人数
     */
    private Integer userApplyEnterNum;
    /**
     * 当前登录用户宴会已申请人数
     */
    private Integer userApplyBanquetNum;
    /**
     * 当前登录用户住宿已申请人数
     */
    private Integer userApplyLodgingNum;

    /**
     * 当前登录用户逛展已申请人数
     */
    private Integer userApplyVisitExhibitionNum;
    /**
     * 退押金任务是否开启 0否 1是
     */
